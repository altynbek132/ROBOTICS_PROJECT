...
def main():
    ...
    with open(file_name, 'a') as f:
        f.write('time PosLHipYaw VelLHipYaw ForLHipYaw PosLHipPitch VelLHipPitch ForLHipPitch PosLHipRoll VelLHipRoll ForLHipRoll PosLKnee VelLKnee ForLKnee PosLAnklePitch VelLAnklePitch ForLAnklePitch PosLAnkleRoll VelLAnkleRoll ForLAnkleRoll')
        f.write('\n')
...
def gen_force():
    return generateRandomBetween(-14.2, 14.2)
